...
| ------------- | ------------- | ------------- | ------------- |
| [Assets](https://github.com/Terascale-All-sensing-Research-Studio/vr-queue-waiting-sound-dataset/blob/main/Cybersickness/) | Yes | MP3 and meta | Contains two subfolders, namely [No_Sound_Audio_Files](https://github.com/Terascale-All-sensing-Research-Studio/vr-queue-waiting-sound-dataset/blob/main/Cybersickness/No_Sound_Audio_Files) and [Sound_Audio_Files](https://github.com/Terascale-All-sensing-Research-Studio/vr-queue-waiting-sound-dataset/blob/main/Cybersickness/Sound_Audio_Files), which contain the audio assets in MP3 and metadata (meta) format. The audio files are generated using [ElevenLabs](https://elevenlabs.io/). 
